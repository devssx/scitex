...
GUI::Window Strip::CreateButton(const char *text, size_t ident, bool check) {
	...
	if (check) {
		...
		switch (ident) {
		case IDWHOLEWORD: resNum = IDB_WORD; break;
		case IDMATCHCASE: resNum = IDB_CASE; break;
		case IDREGEXP: resNum = IDB_REGEX; break;
		case IDUNSLASH: resNum = IDB_BACKS; break;
		case IDWRAP: resNum = IDB_AROUND; break;
		case IDDIRECTIONUP: resNum = IDB_UP; break;
		}
